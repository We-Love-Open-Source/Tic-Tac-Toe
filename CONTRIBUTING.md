...
- `maintainers` label are internal tasks that will be completed by a project core team member. 
- [good first issue](https://github.com/We-Love-Open-Source/Tic-Tac-Toe/labels/good%20first%20issue) labeled issues are meant for newer developers.
- [enhancement](https://github.com/We-Love-Open-Source/Tic-Tac-Toe/labels/enhancement) labeled issues are meant to propose new features.
- [bugs](https://github.com/We-Love-Open-Source/Tic-Tac-Toe/labels/bug) labeled issues are meant to have errors in existing code base.
- [documentation](https://github.com/We-Love-Open-Source/Tic-Tac-Toe/labels/documentation) labeled issues are meant to have typo errors in documentation.
...
1. Fork the project and clone it to your local machine. Follow the [setup](https://github.com/SETUP.md) guideline.
...
- [awaiting-approval](l) labeled PRs are meant to be waiting for other communtiy members.

## Community
Discussions about project issues and features take place on the repository's [Discussions]() sections. Anybody is welcome to join these conversations. See the [README](README.md) for more information on communication channels.

### Financial Contributors

Becoming a [financial contributor]() helps us sustain our community and platform.
